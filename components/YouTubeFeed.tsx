  ...
  return (
    <section id="videos" className="mt-16 scroll-mt-32" aria-labelledby="videos-heading">
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <a className="social-icon-link text-sm text-white/65 hover:text-white" href={`https://www.youtube.com/channel/${channelId}/videos`} target="_blank" rel="noopener noreferrer"><SocialIcon platform="YouTube" />View YouTube channel ↗</a>
      </div>
